...
public class UsuarioService {
	...
	public String login(@PathVariable("correo") String correo,@PathVariable("password") String pasword) {
		String login = "ERROR";
		List<Usuario> usuario = usuarioRepository.findByCorreoAndPassword(correo, pasword);
		if(!usuario.isEmpty()) {
		login = "OK";	
		}
		return login;
